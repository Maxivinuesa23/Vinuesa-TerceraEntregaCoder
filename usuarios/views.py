    ...
    if request.method == "POST":
        ...
        if formulario.is_valid():
            ...
            if formulario.cleaned_data.get('descripcion'):
                infoextra.descripcion = formulario.cleaned_data.get('descripcion')
        ...
        formulario  = FormularioEdicionPerfil(initial={'avatar': infoextra.avatar, 'descripcion': infoextra.descripcion}, instance=request.user)
